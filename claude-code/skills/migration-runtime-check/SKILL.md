...
- 결과물은 side 아래에서 context 단위로 먼저 끊는다: `<side>/<contextId>/pages/<scenarioId>`.
...
#### Page Capture
- screenshot:
  - A: A/<contextId>/pages/<scenarioId>/page.png
  - B: B/<contextId>/pages/<scenarioId>/page.png
...
- screenshot:
  - A: A/<contextId>/pages/<scenarioId>/flows/<flowId>/step-<N>/page.png
  - B: B/<contextId>/pages/<scenarioId>/flows/<flowId>/step-<N>/page.png
