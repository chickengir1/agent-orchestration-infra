...
<repo-root>/.claude/migration-runtime-check/
  ...
  run-<n>/
    A/
      stamp.json
      pages/<scenarioId>/{capture.json, page.png}
    B/
      stamp.json
      pages/<scenarioId>/{capture.json, page.png}
    report.md
...
python3 plan_helper.py \
  ...
  --context-id group-2-default --vars group_id=2 \
